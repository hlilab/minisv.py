...
test1() {
    ...
    minisv extract -b ../data/chm13v2.cen-mask.bed -n COLO829T test.gaf.gz > test.gsv
...
test2() {
    ...
    minisv extract -b ../data/chm13v2.cen-mask.bed -n HCC1954T hcc1954_test.gaf.gz > hcc1954_test.gsv
...
test2_full() {
    minisv extract -b ../data/chm13v2.cen-mask.bed -n HCC1954T pair_v2/HCC1954T.chm13g.paf.gz > hcc1954_test.gsv
    num=$(cat hcc1954_test.gsv | wc -l)
