...
test1() {
    ...
    #minisv eval -s -b ~/data/pangenome_sv_benchmarking/minisv/data/hs38.reg.bed /homes6/hli/hli1/gafcall/COLO829.truth.hs38.vcf ../../1a.alignment_sv_tools/output/nanomonsv/COLO829_hifi1/grch38_tnpair.vcf > test1.eval
