...
/hlilab/alvin/miniconda3/bin/k8 ../../minisv/minisv.js eval -b ~/data/pangenome_sv_benchmarking/minisv/data/hs38.reg.bed -a /homes6/hli/hli1/gafcall/COLO829.truth.hs38.vcf ../../1a.alignment_sv_tools/output/severus/COLO829_hifi1/grch38/somatic_SVs/severus_somatic.vcf ../../1a.alignment_sv_tools/output/nanomonsv/COLO829_hifi1/grch38_tnpair.vcf  > test2.eval
